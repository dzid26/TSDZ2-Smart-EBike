...
// compile time asserts for the config.h file

#define static_assert_(x) static_assert(x, #x)


// MOTOR_TYPE 0
static_assert(MOTOR_TYPE == 0 || MOTOR_TYPE == 1, "MOTOR_TYPE must be 0 or 1, which corresponds to 36V or 48V");
// TORQUE_SENSOR_CALIBRATED 0
static_assert(TORQUE_SENSOR_CALIBRATED == 0 || TORQUE_SENSOR_CALIBRATED == 1, "TORQUE_SENSOR_CALIBRATED must be 0 or 1");
// MOTOR_ACCELERATION  35
static_assert_(MOTOR_ACCELERATION > 0 && MOTOR_ACCELERATION <= 100);
// MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION 0
static_assert_(MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION == 0 || MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION == 1);
// ASSISTANCE_WITHOUT_PEDAL_ROTATION_THRESHOLD 20

// PEDAL_TORQUE_PER_10_BIT_ADC_STEP_X100 67
// PEDAL_TORQUE_ADC_MAX 300
// STARTUP_BOOST_TORQUE_FACTOR 300
// MOTOR_BLOCKED_COUNTER_THRESHOLD 2
// MOTOR_BLOCKED_BATTERY_CURRENT_THRESHOLD_X10 30
// MOTOR_BLOCKED_ERPS_THRESHOLD 20
// STARTUP_BOOST_CADENCE_STEP 20
// BATTERY_CURRENT_MAX 13
// TARGET_MAX_BATTERY_POWER 500
// TARGET_MAX_BATTERY_CAPACITY 500
// BATTERY_CELLS_NUMBER 13
// MOTOR_DECELERATION 35
// BATTERY_LOW_VOLTAGE_CUT_OFF 39
// ACTUAL_BATTERY_VOLTAGE_PERCENT 100
// ACTUAL_BATTERY_CAPACITY_PERCENT 90
// LI_ION_CELL_OVERVOLT 4.35
// LI_ION_CELL_RESET_SOC_PERCENT 4.10
// LI_ION_CELL_VOLTS_FULL 4.10
// LI_ION_CELL_VOLTS_3_OF_4 3.85
// LI_ION_CELL_VOLTS_2_OF_4 3.60
// LI_ION_CELL_VOLTS_1_OF_4 3.35
// LI_ION_CELL_VOLTS_5_OF_6 3.94
// LI_ION_CELL_VOLTS_4_OF_6 3.76
// LI_ION_CELL_VOLTS_3_OF_6 3.60
// LI_ION_CELL_VOLTS_2_OF_6 3.44
// LI_ION_CELL_VOLTS_1_OF_6 3.26
// LI_ION_CELL_VOLTS_EMPTY 3.10
// WHEEL_PERIMETER 2200
// WHEEL_MAX_SPEED 25
// ENABLE_LIGHTS 1
// ENABLE_WALK_ASSIST 1
// ENABLE_BRAKE_SENSOR 0
// ENABLE_THROTTLE 0
// ENABLE_TEMPERATURE_LIMIT 0
// ENABLE_STREET_MODE_ON_STARTUP 1
// ENABLE_SET_PARAMETER_ON_STARTUP 0
// ENABLE_ODOMETER_COMPENSATION 0
// STARTUP_BOOST_ON_STARTUP 1
// TORQUE_SENSOR_ADV_ON_STARTUP 0
// LIGHTS_CONFIGURATION_ON_STARTUP 0
// RIDING_MODE_ON_STARTUP 1
// LIGHTS_CONFIGURATION_1 1
// LIGHTS_CONFIGURATION_2 9
// LIGHTS_CONFIGURATION_3 10
// STREET_MODE_POWER_LIMIT_ENABLED 1
// STREET_MODE_POWER_LIMIT 500
// STREET_MODE_SPEED_LIMIT 25
// STREET_MODE_THROTTLE_ENABLED 0
// STREET_MODE_CRUISE_ENABLED 0
// ADC_THROTTLE_MIN_VALUE 47
// ADC_THROTTLE_MAX_VALUE 176
// MOTOR_TEMPERATURE_MIN_VALUE_LIMIT 65
// MOTOR_TEMPERATURE_MAX_VALUE_LIMIT 95
// ENABLE_TEMPERATURE_ERROR_MIN_LIMIT 0
// ENABLE_VLCD6 0
// ENABLE_VLCD5 1
// ENABLE_XH18 0
// ENABLE_DISPLAY_WORKING_FLAG 1
// ENABLE_DISPLAY_ALWAYS_ON 0
// ENABLE_WHEEL_MAX_SPEED_FROM_DISPLAY 0
// DELAY_MENU_ON 50
// COASTER_BRAKE_ENABLED 0
// COASTER_BRAKE_TORQUE_THRESHOLD 30
// ENABLE_AUTO_DATA_DISPLAY 1
// STARTUP_ASSIST_ENABLED 0
// DELAY_DISPLAY_DATA_1 50
// DELAY_DISPLAY_DATA_2 50
// DELAY_DISPLAY_DATA_3 50
// DELAY_DISPLAY_DATA_4 50
// DELAY_DISPLAY_DATA_5 50
// DELAY_DISPLAY_DATA_6 50
// DISPLAY_DATA_1 1
// DISPLAY_DATA_2 2
// DISPLAY_DATA_3 10
// DISPLAY_DATA_4 7
// DISPLAY_DATA_5 4
// DISPLAY_DATA_6 8
// POWER_ASSIST_LEVEL_1 50
// POWER_ASSIST_LEVEL_2 100
// POWER_ASSIST_LEVEL_3 160
// POWER_ASSIST_LEVEL_4 260
// TORQUE_ASSIST_LEVEL_1 50
// TORQUE_ASSIST_LEVEL_2 80
// TORQUE_ASSIST_LEVEL_3 120
// TORQUE_ASSIST_LEVEL_4 160
// CADENCE_ASSIST_LEVEL_1 80
// CADENCE_ASSIST_LEVEL_2 100
// CADENCE_ASSIST_LEVEL_3 130
// CADENCE_ASSIST_LEVEL_4 160
// EMTB_ASSIST_LEVEL_1 60
// EMTB_ASSIST_LEVEL_2 100
// EMTB_ASSIST_LEVEL_3 140
// EMTB_ASSIST_LEVEL_4 180
// WALK_ASSIST_LEVEL_1 30
// WALK_ASSIST_LEVEL_2 35
// WALK_ASSIST_LEVEL_3 40
// WALK_ASSIST_LEVEL_4 45
// WALK_ASSIST_THRESHOLD_SPEED_X10 60
// WALK_ASSIST_DEBOUNCE_ENABLED 0
// WALK_ASSIST_DEBOUNCE_TIME 60
// CRUISE_TARGET_SPEED_LEVEL_1 15
// CRUISE_TARGET_SPEED_LEVEL_2 18
// CRUISE_TARGET_SPEED_LEVEL_3 21
// CRUISE_TARGET_SPEED_LEVEL_4 24
// CRUISE_MODE_WALK_ENABLED 0
// CRUISE_THRESHOLD_SPEED 10
// PEDAL_TORQUE_ADC_OFFSET 150
// AUTO_DATA_NUMBER_DISPLAY 3
// UNITS_TYPE 0
// ASSIST_THROTTLE_MIN_VALUE 0
// ASSIST_THROTTLE_MAX_VALUE 255
// STREET_MODE_WALK_ENABLED 1
// DATA_DISPLAY_ON_STARTUP 1
// FIELD_WEAKENING_ENABLED 0
// PEDAL_TORQUE_ADC_OFFSET_ADJ 20
// PEDAL_TORQUE_ADC_RANGE_ADJ 20
// PEDAL_TORQUE_ADC_ANGLE_ADJ 36
// PEDAL_TORQUE_PER_10_BIT_ADC_STEP_ADV_X100 34
// SOC_PERCENT_CALC 0
// STARTUP_BOOST_AT_ZERO 0
// ENABLEC850 0
// STREET_MODE_THROTTLE_LEGAL 0
// BRAKE_TEMPERATURE_SWITCH 0
// eMTB_BASED_ON_POWER 1
// SMOOTH_START_ENABLED 1
// SMOOTH_START_SET_PERCENT 35
// TEMPERATURE_SENSOR_TYPE 0
// CRUISE_MODE_ENABLED 1
// THROTTLE_MODE 0
// STREET_MODE_THROTTLE_MODE 0
// ASSIST_LEVEL_1_OF_5_PERCENT 60
// ALTERNATIVE_MILES 0
